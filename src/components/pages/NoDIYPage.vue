<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h1 class="text-2xl font-bold">NO DIY 紀錄</h1>
      <!-- 清空歷史紀錄按鈕 -->
      <button
    ...
    >
      <div class="bg-white p-6 rounded-lg max-w-md w-full mx-4">
        ...
        <!-- 訊息內容 -->
        <p class="text-gray-600 mb-6">此操作將永久刪除所有不自己動手紀錄，無法復原。確定要繼續嗎？</p>
...
import { ref } from 'vue'
import NoDIYButton from '@/components/nodiy/NoDIYButton.vue';
import NoDIYResultDisplay from '@/components/nodiy/NoDIYResultDisplay.vue';
import NoDIYChart from '@/components/nodiy/NoDIYChart.vue';
...
const handleClearHistory = () => {
  noDIYStore.clearAllHistory() // 清空所有歷史紀錄
