<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h1 class="text-2xl font-bold">唱歌練習紀錄</h1>
      <!-- 清空歷史紀錄按鈕 -->
      <button
    ...
    >
      <div class="bg-white p-6 rounded-lg max-w-md w-full mx-4">
        ...
        <!-- 訊息內容 -->
        <p class="text-gray-600 mb-6">此操作將永久刪除所有唱歌練習紀錄，無法復原。確定要繼續嗎？</p>
...
import { ref } from 'vue'
import SingPracticeButton from '@/components/singpractice/SingPracticeButton.vue';
import SingPracticeResultDisplay from '@/components/singpractice/SingPracticeResultDisplay.vue';
import SingPracticeChart from '@/components/singpractice/SingPracticeChart.vue';
...
const handleClearHistory = () => {
  singPracticeStore.clearAllHistory() // 清空所有歷史紀錄
